...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define NEOPIXEL_ZERO 5 // Needs to be high for 1/4 of 20 ticks
#define NEOPIXEL_ONE 10 // high for 1/2 of 20 ticks
...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	PixelGRB_t pixels[NUM_PIXELS];
	uint32_t dmaBuff [DMA_BUFF_SIZE];
  /* USER CODE END 1 */
